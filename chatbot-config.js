...
const CHATBOT_CONFIG = {
    ...
    DEEPSEEK_API_KEY: 'YOUR_DEEPSEEK_API_KEY', // À remplacer par votre clé API
...
const ChatbotUtils = {
    ...
    // Valider la clé API
    validateApiKey: () => {
        return CHATBOT_CONFIG.DEEPSEEK_API_KEY && CHATBOT_CONFIG.DEEPSEEK_API_KEY !== 'YOUR_DEEPSEEK_API_KEY';
    }
};
